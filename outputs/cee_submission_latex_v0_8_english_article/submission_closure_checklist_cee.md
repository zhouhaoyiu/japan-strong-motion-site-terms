...
- [x] Abstract is below 150 words, contains no citations and moves directly from one background sentence to the analysis.
...
- [x] All 34 main references and 12 Supplementary Information references have a DOI or official HTTPS source and appear in first-citation order.
- [x] English and Chinese reference lists use the same 34 records in the same order.
