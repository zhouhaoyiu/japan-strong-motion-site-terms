...
- Sampling reliability is evaluated with repeated disjoint event halves at 1, 2 and 3 s. Each station requires at least 5 records per half; component offsets are aligned to the full-sample reference before the halves are compared.
...
- Hypocentral-bearing sectors: mean split-half correlations span 0.762--0.967; each split retains at least 300 paired stations.
- Shortest-fault-distance bins: mean split-half correlations span 0.563--0.968; each split retains at least 77 paired stations.
- Source classes: mean split-half correlations span 0.902--0.979; each split retains at least 860 paired stations.
