...
Analysis and figure-generation code is available at \url{https://github.com/zhouhaoyiu/japan-strong-motion-site-terms}. The repository includes environment specifications, reproduction commands and workflows for the primary and Zhao residual calculations, uncertainty propagation, transfer tests, path stratification and balanced-field sensitivity.
